# ![Frontend Mentor](https://www.frontendmentor.io/static/images/logo-mobile.svg) Frontend Mentor Challenges
...
| Nome do Desafio           | Tecnologias Utilizadas | Link do Projeto                                                                      | Deploy |
| ------------------------- | ---------------------- | ------------------------------------------------------------------------------------ | ------ |
| Testimonials grid section | HTML, Tailwind CSS     | [Link](https://www.frontendmentor.io/challenges/testimonials-grid-section-Nnw6J7Un7) | [Link](https://testimonials-grid-section-x.netlify.app/)|
